...
## DL-04: No Data Export / Portability Function (CCPA)
...
- Export function exists but omits tables (check it covers all PII tables)
- Export format is not machine-readable (CCPA requires structured format)

Why it matters: CCPA grants users the right to receive a copy of their data
in a portable, machine-readable format. This must be implemented.
